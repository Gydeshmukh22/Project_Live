...
function Training() {
    return (
        < div className='bg-slate-200'>
            ...
            <div className='mt-20'>
                <div className="bg-[url(https://images.unsplash.com/photo-1604134967494-8a9ed3adea0d?auto=format&fit=crop&q=80&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=1974)] h-[400px] w-full  border-4  mt-1 contain  relative ">
                    <div className=" p-16 m-12 bg-gray-500/50 w-2/3 text-center rounded-full">
